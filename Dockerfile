...
# Executar o binário x86 steamcmd diretamente com box86 - Forçar tipo de plataforma e quit, com HOME
RUN HOME=/root box86 linux32/steamcmd +@sSteamCmdForcePlatformType linux +quit
